<form id="alta-contacto" name="alta_frm" action="php/agregar-contacto.php" method="POST" enctype="multipart/form-data">
		<fieldset>
			<legend>Alta de Contacto</legend>
				<div>
					<!--For linkea la etiqueta al input-->
				...
				<div>
					...
					<input type="text" id="nombre" class="cambio" name="nombre_txt" placeholder="Tu nombre" title="Tu nombre" required />
				</div>
				...
				<div>
					<label for="nacimiento">Fecha de nacimiento: </label>
						<input type="date" id="nacimiento" class="cambio" name="nacimiento_txt" title="Tu cumple"  />
				</div>

				<div>
					<label for="telefono">Telefono: </label>
						<input type="number" id="telefono" class="cambio" name="telefono_txt" placeholder="Escribe tu tel&eacute;fono" title="Tu telefono" required /> 
				...
				<div>
					...
					<!--Cuando se desea aplicar mas de una clase se separan por espacios en blanco. La clase
						adjuntar-archivo es para corregir el interprete del input file en los navegadores-->
